...
def train(cfg: DictConfig):
    ...
    def get_loss_grad(is_penalty=False):
        if is_penalty:
            loss = get_loss_pen()
        else:
            loss = get_loss()
    ...
    def get_loss_grad2(lamba=1e-3):
        def loss_grad_fn(params, threshold):
            ...
            reg_val, reg_grad = jax.value_and_grad(get_reg())(params, threshold)
    ...
    loss_grad_1 = get_loss_grad()
    loss_grad_2 = get_loss_grad2(reg_factor)
